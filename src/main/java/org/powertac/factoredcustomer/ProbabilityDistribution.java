...
final class ProbabilityDistribution
{
  ...
  ProbabilityDistribution (FactoredCustomerService service, Element xml)
  {
    if (null == randomSeedRepo)
      randomSeedRepo = service.getRandomSeedRepo();
    ...
    case GAUSSIAN:
      ...
      param2 = Double.parseDouble(xml.getAttribute("stdDev"));
      sampler =
        new ContinuousSampler(new NormalDistributionImpl(param1, param2));
      break;
    case STDNORMAL:
      param1 = 0;
      param2 = 1;
    ...
    case CAUCHY:
      ...
      sampler =
        new ContinuousSampler(new CauchyDistributionImpl(param1, param2));
      break;
    case BETA:
    ...
    case BINOMIAL:
      ...
      sampler =
        new DiscreteSampler(new BinomialDistributionImpl((int) param1, param2));
      break;
    case POISSON:
    ...
    case GAMMA:
      ...
      param2 = Double.parseDouble(xml.getAttribute("beta"));
      sampler =
        new ContinuousSampler(new GammaDistributionImpl(param1, param2));
      break;
    case WEIBULL:
      param1 = Double.parseDouble(xml.getAttribute("alpha"));
      param2 = Double.parseDouble(xml.getAttribute("beta"));
      sampler =
        new ContinuousSampler(new WeibullDistributionImpl(param1, param2));
      break;
    case STUDENT:
      param1 = Double.parseDouble(xml.getAttribute("dof"));
    ...
    sampler.reseedRandomGenerator(randomSeedRepo
        .getRandomSeed("factoredcustomer.ProbabilityDistribution",
  ...
  double drawSample ()
  {
    try {
      ...
      System.err.println("ProbabilityDistribution(" + toString()
                         + ") - drawSample():" + toString()
                         + " Caught MathException:\n");
      e.printStackTrace(System.err);
      throw new Error("ProbabilityDistribution(" + toString()
                      + ") - drawSample(): Caught MathException: "
                      + e.toString());
    }
  }
